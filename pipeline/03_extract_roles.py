...
CANON = [
    ...
    ('DevOps / SRE',               ['devops','site reliability',' sre','platform engineer','build and release','cloudops','infrastructure engineer','devsecops']),
    ...
    ('QA / Test Engineer',         ['qa','quality assurance','test engineer','sdet','automation test','software tester','testing','test analyst','uat','performance testing','load testing','quality analyst','software development engineer in test','software development engineer in tests']),
    ...
    ('Eng Manager / Tech Lead',    ['engineering manager','tech lead','technical lead','team lead','development lead','delivery lead','engineering lead','software lead','module lead','scrum master','agile coach','application lead']),
    ('SAP Consultant',             ['sap']),
    ...
    ('Software Engineer (General)',['software engineer','software developer','programmer','sde ','application developer','it developer','software development engineer',
